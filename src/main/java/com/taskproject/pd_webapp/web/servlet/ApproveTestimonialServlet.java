...
@WebServlet("/admin/testimonials/approve")
public class ApproveTestimonialServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            testimonialDAO.approveTestimonial(testimonialId);

            response.sendRedirect(request.getContextPath()
                    + "/admin/testimonials?success=testimonialApproved");
