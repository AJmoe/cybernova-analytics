...
-- Purpose: Store security issue requests from clients
-- =============================================
...
-- =============================================
-- TABLE: technical_problems
-- Purpose: Store categorized technical security problems
-- =============================================
...
-- =============================================
-- TABLE: cyber_blog_articles
-- Purpose: Store cybersecurity blog articles
-- =============================================
...
-- =============================================
-- TABLE: case_studies
-- Purpose: Store cybersecurity case studies
-- =============================================
...
-- =============================================
-- TABLE: testimonials
-- Purpose: Store client testimonials and ratings
-- =============================================
...
-- Purpose: Store workshop and cybersecurity training events
-- =============================================
...
-- =============================================
-- TABLE: workshop_gallery
-- Purpose: Store images/media from workshops and events
-- =============================================
...
-- =============================================
-- TABLE: solutions (Cybersecurity Solutions)
-- Purpose: Store detailed cybersecurity solutions offered
-- =============================================
...
-- Purpose: Store analytics about service requests and demand
-- =============================================
...
-- =============================================
-- TABLE: request_type_analytics
-- Purpose: Aggregate analytics by request type
-- =============================================
...
-- =============================================
-- TABLE: regional_demand
-- Purpose: Track regional cybersecurity service demand
-- =============================================
...
-- Insert sample admin user (Username: admin, Password: admin123 - MD5: 0192023a7bbd73250516f069df18b500)
...
-- Insert sample technical problems
...
-- Insert sample cybersecurity solutions
...
-- =============================================
-- CyberNova Analytics Database is now ready for use
-- All tables, indexes, and views have been created
-- Sample data has been inserted for reference
